...
def get_default_trainer_types() -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    print("Registering default Trainer types")
    mla_plugins.all_trainer_types.update(
        {
            ...
            DQNTrainer.get_trainer_name(): DQNTrainer,
        }
    )
    # global all_trainer_settings
    print("Registering default Trainer settings")
    mla_plugins.all_trainer_settings.update(
        {
            ...
            DQNTrainer.get_trainer_name(): DQNSettings,
        }
    )
    print("Trainer types registered:", mla_plugins.all_trainer_types.keys())
    print("Trainer settings registered:", mla_plugins.all_trainer_settings.keys())
